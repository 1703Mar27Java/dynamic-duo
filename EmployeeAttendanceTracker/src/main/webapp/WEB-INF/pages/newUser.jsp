...
<body>
	...
	<div class="form-container">
		<h2>
			Please fill in the form below<br /> to create a new account!
		</h2>
		<br />
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4" id="form">
				...
				<form:form id="NewUserForm" action="newUser" commandName="userForm">
					<div class="form-group">
						<br /> <label for="userrole">Select User Role</label> <select
							class="form-control" id="userrole" name="userrole">
							<option id="Employee">Employee</option>
							<option id="Manager">Manager</option>
							<form:input id="hiddenRoleForm" type="hidden"
								class="form-control" path="userRole" size="30" />
						</select>
					</div>
