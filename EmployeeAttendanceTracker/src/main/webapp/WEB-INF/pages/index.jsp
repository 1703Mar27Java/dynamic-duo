		...
		<div class="form-container">
			...
			<div class="row">
				...
				<div class="col-md-4" id="form">
					...
					<form:form id="RegisterForm" action="register"
						...
						<div class="form-group">
							<label for="pwd">Confirm Password:</label>
							<form:password id="pw2Form" class="form-control" path="password2"
								size="30" />
							<label id="pwMatchWarning" style="color: red; font-style: italic">passwords
								have to match</label>
						</div>
						<div class="checkbox">
							<label><input type="checkbox"> Remember me</label>
